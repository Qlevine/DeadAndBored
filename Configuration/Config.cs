...
namespace DeadAndBored.Configuration
{
    internal static class Config
    {
        ...
        public static void Init()
        {
            ...
            deadAndTalkingKeyConfig = config.Bind("Config", "Key To Talk", KeyCode.Y, "Key press to talk as enemy (when spectating enemy). WILL BE OVERWRITTEN BY IN GAME CONFIGS IF USING INPUTUTILS");
            ...
            manuallyResetAudioDataConfig = config.Bind("Config", "If a player loses audio, they can press this key to reset their audio data.", KeyCode.U, "Key press to manually reset audio data. WILL BE OVERWRITTEN BY IN GAME CONFIGS IF USING INPUTUTILS");
        }
